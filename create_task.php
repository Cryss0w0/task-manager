...
<head>
    ...
    <script>
    function trackTaskCreation() {
        gtag('event', 'create_task', {
            'event_category': 'Task',
            'event_label': "Task creating"
        });
    }
</script>
...
<div class="container">
    ...
    <form method="POST" action="create_task.php" onsubmit="trackTaskCreation()">
        ...
        <button type="submit">Create Task tesing</button>
    </form>
</div>
